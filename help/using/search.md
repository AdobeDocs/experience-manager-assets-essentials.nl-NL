...
1. Navigeer naar **[!UICONTROL Settings]** > **[!UICONTROL General Settings]** .
...
![&#x200B; Contextual het Voorbeeld van het Onderzoek 1 &#x200B;](/help/using/assets/contextual-search-example1.png)
...
* [Een video bekijken om te zoeken naar elementen in Elementen](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/using.html?lang=nl-NL)
